...
<body>
    <main class="container">
        <section class="card">
            ...
            <form action="process.php" method="post" enctype="multipart/form-data" id="studentForm" novalidate data-lookup-url="lookup_student.php">
                <input type="hidden" name="form_mode" id="form_mode" value="">
                <input type="hidden" name="student_id" id="student_id" value="">

                <label for="matric_no">Matric Number</label>
                <div class="matric-check-row">
                    <input type="text" id="matric_no" name="matric_no" required maxlength="100" placeholder="e.g. 230303010052" autocomplete="off">
                    <button type="button" id="checkMatricBtn" class="secondary-action">Check Matric</button>
                </div>
                <p class="warning" id="matricStatus">Enter your matric number first, then click "Check Matric" to continue.</p>
                ...
                <fieldset id="detailsFieldset" disabled>
                    ...
                    <div class="instruction-ack">
                        <input type="checkbox" id="photoInstructionAck" name="photo_instruction_ack" value="1">
                        <label for="photoInstructionAck">I have read and understood the photo instructions.</label>
                    </div>
                    <input type="file" id="image" name="image" accept=".jpg,.jpeg,.png,.webp,image/jpeg,image/png,image/webp" disabled>
